...
@WebServlet(name = "CaClientJson", urlPatterns = {"/CaClientJson"})
public class CaClientJsonServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ArrayList<Couple> couples = dao.getCaByClients(debut, fin);
